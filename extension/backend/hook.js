...
function patcher() {
  ...
  // Object.defineProperty(window, "__RELAY_DEV_HOOK__", {
  //   registerEnvironment: (environment) => {
  //     Object.defineProperty(window, "__RELAY__",{
  //       store: (dataID) => {
  ...
  Object.defineProperty(window, "PROTOSTAR", { value: 50 });
...
patcher();
  ...
  // if (!devTools) {
  //   sendToContentScript(
  //     "React DevTools is not activated, please activate React DevTools!"
  //   );
  // }
...
//         treeArr.push(
//           getSelectorAtomLink(treeArr[0], "nodeToNodeSubscriptions")
//         );
...
//         sendToContentScript(
//           "Error: something went wrong with our application, please submit the issue on https://github.com/oslabs-beta/TotalRecoilJS"
//         );
//       }
...
//     if (
//       component.state[i]["current"] instanceof Set ||
//       component.state[i]["current"] instanceof Map
//     ) {
...
//       return stateNode.type && typeof stateNode.type !== "string"
//         ? `<${stateNode.type.name} />`
//         : "React component";
//     }
